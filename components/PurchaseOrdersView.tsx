...
import { PurchaseOrdersHook, PurchaseOrder, InventoryHook, ManufacturingHook } from '../types';
...
export const PurchaseOrdersView: React.FC<PurchaseOrdersViewProps> = ({ purchaseOrdersHook, inventory, manufacturing }) => {
    ...
    const handleExportPDF = async () => {
        ...
        savePdfResiliently(doc, `relatorio_ordens_compra_${getTimestamp()}.pdf`);
    };
