...
export const ManualView: React.FC = () => {
    ...
    const handleDownloadPDF = async () => {
        ...
        try {
            const canvas = await html2canvas(manualRef.current, { 
                ...
                onclone: (clonedDoc) => {
                    ...
                    for (let i = 0; i < elements.length; i++) {
                        ...
                        // These properties are known to use oklch in Tailwind 4
                        const colorProps = ['color', 'backgroundColor', 'borderColor', 'fill', 'stroke', 'outline-color', 'text-decoration-color'];
            ...
            savePdfResiliently(pdf, 'Manual_do_Software.pdf');
        } catch (error) {
