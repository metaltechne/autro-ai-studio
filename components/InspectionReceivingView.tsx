                                                                ...
                                                                <Button 
                                                                    ...
                                                                    onClick={async () => {
                                                                        const newComp: Component = {
                                                                            ...
                                                                            sourcing: (activeTab as string) === 'fabrication' ? 'manufactured' : 'purchased'
                                                                        };
                        ...
                        <Card className="overflow-hidden">
                            <div className="p-0 overflow-x-auto">
                                <table className="w-full text-left border-collapse">
                                    ...
                                    <tbody>
                                        {fabricationItemsAwaiting.map((item, idx) => {
                                            const component = inventory.findComponentById(item.componentId) || inventory.findComponentBySku(item.componentId);
                                            return (
                                                <tr key={`${item.orderId}-${item.componentId}-${idx}`} className="border-b border-slate-50 hover:bg-slate-50/50 transition-colors">
                                                    <td className="p-4">
