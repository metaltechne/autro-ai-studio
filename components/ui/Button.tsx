...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(({ children, variant = 'primary', size = 'md', className = '', ...props }, ref) => {
  ...
  const sizeClasses = {
    sm: 'px-2 py-1 sm:px-3 sm:py-1.5 text-[9px] sm:text-[10px]',
    md: 'px-4 py-2 sm:px-5 sm:py-2.5 text-[11px] sm:text-xs',
    lg: 'px-6 py-3 sm:px-8 sm:py-4 text-xs sm:text-sm',
    icon: 'p-2 sm:p-2.5'
  };
