...
export const InventoryHistoryModal: React.FC<InventoryHistoryModalProps> = ({ isOpen, onClose, component, logs, size }) => {
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={`Histórico de Movimentações: ${component.name}`} size={size}>
