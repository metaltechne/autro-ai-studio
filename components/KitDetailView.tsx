                    ...
                    {kit.compatibilityRules && kit.compatibilityRules.length > 0 && (
                        <Card className="border-none shadow-soft">
                            ...
                            <div className="space-y-3">
                                {kit.compatibilityRules.map((rule, idx) => (
                                    <div key={idx} className="p-4 bg-slate-50 rounded-xl border border-slate-100 flex flex-col md:flex-row md:items-center gap-2">
