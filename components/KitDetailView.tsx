...
import { InventoryHook, ManufacturingHook, Kit, View, ScannedQRCodeData, KitCostBreakdownItem, SaleDetails, Component, FamiliaComponente } from '../types';
    ...
    const costDetails = useMemo(() => {
        ...
        if (kit.requiredFasteners) {
            kit.requiredFasteners.forEach(rf => {
                ...
                // Tentar calcular custo se houver uma família vinculada
                if (fastenerFamilia) {
        ...
        const saleDetails = calculateSaleDetails(totalCost, {
        ...
        return { totalCost, breakdown: breakdown.sort((a,b) => b.totalCost - a.totalCost), saleDetails };
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <Card>
                        <h3 className="text-xl font-bold text-black mb-4">Composição de Materiais e Fixadores</h3>
                        <div className="overflow-hidden border rounded-xl">
                            <table className="min-w-full divide-y divide-gray-200">
                                ...
                                <tfoot className="bg-slate-900 text-white font-black">
                                    <tr>
                                        <td className="px-4 py-4 text-sm uppercase tracking-widest">Custo Total Estrutura</td>
                                        <td colSpan={2} className="px-4 py-4 text-right text-lg text-emerald-400">{formatCurrency(costDetails.totalCost)}</td>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
