    ...
    return (
        <div className="flex flex-col h-full max-w-[1600px] mx-auto">
            ...
            <div className="flex-grow flex gap-6 overflow-x-auto pb-4 min-h-0">
                {columns.map(col => (
                    <div key={col.id} className={`flex-1 min-w-[300px] flex flex-col rounded-2xl border-2 ${col.borderColor} ${col.color} overflow-hidden`}>
                                    ...
                                    <div key={task.id} className={`bg-white p-4 rounded-xl shadow-sm border ${isOverdue ? 'border-rose-300' : 'border-slate-200'} hover:shadow-md transition-shadow group relative`}>
                                        <div className="flex justify-between items-start mb-2">
                                            ...
                                            <div className="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                                ...
                                                }} className="p-1 text-slate-400 hover:text-rose-600 transition-colors"><Trash2 className="w-3.5 h-3.5" /></button>
                                            </div>
                                        </div>
