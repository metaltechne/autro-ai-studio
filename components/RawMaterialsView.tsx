...
const MaterialModal: React.FC<{
    isOpen: boolean;
    onClose: () => void;
    onSave: (material: any) => Promise<any>;
    ...
    const handleSave = async () => {
        if (!data.name || !data.sku) {
            // Using a simple check here, but ideally we'd use a toast. 
            // Since MaterialModal doesn't have useToast, we'll just return for now or add it.
            return;
        }
        await onSave(data);
        onClose();
