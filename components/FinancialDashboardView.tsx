             ...
             if (kit.requiredFasteners) {
                kit.requiredFasteners.forEach(rf => {
                    ...
                    if (!isNaN(bitola)) {
                        ...
                        const result = evaluateProcess(familiaToUse || fastenerFamilia || manufacturing.familias[0], { bitola, comprimento }, inventory.components, {}, { allFamilias: manufacturing.familias });
                        totalCost += (result.custoFabricacao + result.custoMateriaPrima) * rf.quantity;

                        // Add Copo Logic for consistency with KitDetailView and KitsView
                        if (!isNut) {
                             ...
                             if (copoFamilia) {
                                  ...
                                  totalCost += (res.custoMateriaPrima + res.custoFabricacao) * rf.quantity;
                             }
                        }
                    }
                });
