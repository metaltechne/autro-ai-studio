            ...
            {mode === 'time' && (
                <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <Input label="TEMPO (s)" type="number" value={data.manualTimeSeconds || 0} onChange={e => onUpdateDetails({ manualTimeSeconds: isNaN(parseFloat(e.target.value)) ? 0 : parseFloat(e.target.value) })} />
                    </div>
                </div>
            )}
...
export const MaterialFormUI = ({ data, onUpdateDetails }: any) => {
    return (
        <div className="space-y-4">
            ...
            <Input label="CONSUMO" type="number" value={data.consumption || ''} onChange={e => onUpdateDetails({ consumption: parseFloat(e.target.value) || 0 })} />
        </div>
    );
};
...
export const InventoryFormUI = ({ data, onUpdateDetails }: any) => {
    ...
    return (
        <div className="space-y-4">
            ...
            <Input label="QUANTIDADE" type="number" value={data.consumption || 1} onChange={e => onUpdateDetails({ consumption: parseFloat(e.target.value) || 1 })} />
        </div>
    );
};
