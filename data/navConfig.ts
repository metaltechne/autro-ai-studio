...
export const navConfig: { title: string; items: NavItemConfig[] }[] = [
    {
        ...
        items: [
            ...
            { id: View.TASKS, label: 'Tarefas e Lembretes', icon: ClipboardCheckIcon, allowedRoles: ['Admin', 'Gestor', 'Vendedor', 'Linha de Produção', 'Fabricação', 'Compras', 'Financeiro'] },
        ]
    },
    {
        title: 'COMERCIAL',
        items: [
            { id: View.SALES_DASHBOARD, label: 'Dashboard de Vendas', icon: ChartPieIcon, allowedRoles: ['Admin', 'Gestor', 'Vendedor'] },
            { id: View.CUSTOMER_SERVICE_DASHBOARD, label: 'Dashboard de Atendimento', icon: DashboardIcon, allowedRoles: ['Admin', 'Gestor', 'Vendedor'] },
            { id: View.SALES_FUNNEL, label: 'Funil de Vendas', icon: ViewBoardsIcon, allowedRoles: ['Admin', 'Gestor', 'Vendedor'] },
            { id: View.WHATSAPP_CRM, label: 'WhatsApp CRM', icon: DocumentTextIcon, allowedRoles: ['Admin', 'Gestor', 'Vendedor'] },
            { id: View.CALLS_CRM, label: 'CRM de Ligações', icon: DocumentTextIcon, allowedRoles: ['Admin', 'Gestor', 'Vendedor'] },
    ...
    },
    {
        ...
        items: [
            ...
            { id: View.INSPECTION_RECEIVING, label: 'Inspeção e Recebimento', icon: ClipboardCheckIcon, allowedRoles: ['Admin', 'Gestor', 'Compras', 'Financeiro'] },
        ]
    },
    {
        title: 'FINANCEIRO',
    ...
    },
    {
        ...
        items: [
            ...
            { id: View.KIT_ENGINEERING, label: 'Engenharia de Kits', icon: PuzzleIcon, allowedRoles: ['Admin', 'Gestor', 'Financeiro'] },
    ...
    },
    {
        ...
        items: [
            ...
            { id: View.MANUAL, label: 'Manual do Software', icon: DocumentTextIcon, allowedRoles: ['Admin', 'Gestor', 'Vendedor', 'Linha de Produção', 'Fabricação', 'Compras', 'Financeiro'] },
