...
export const FIX_S_FAMILIA: FamiliaComponente = {
    ...
    nodes: [
        ...
        { id: 'n-mat-s', type: 'materialMapping', data: { label: 'Matéria-Prima', cost: 0, type: 'materialMapping', dimensions: moedaDims }, position: { x: 300, y: 100 } },
...
export const FIX_P_FAMILIA: FamiliaComponente = {
    ...
    nodes: [
        ...
        { id: 'n-mat-p', type: 'materialMapping', data: { label: 'Matéria-Prima', cost: 0, type: 'materialMapping', dimensions: moedaDims }, position: { x: 300, y: 100 } },
...
export const SEGREDO_CHAVE_S_FAMILIA: FamiliaComponente = {
    ...
    category: 'manufacturing',
    nodes: [
        { id: 'n-dna-segredo', type: 'dnaTableNode', data: { label: 'DNA Geométrico', cost: 0, type: 'dnaTable', dimensions: moedaDims }, position: { x: 100, y: 100 } },
        { id: 'n-mat-segredo', type: 'materialMapping', data: { label: 'Matéria-Prima', cost: 0, type: 'materialMapping', dimensions: moedaDims }, position: { x: 300, y: 100 } },
...
export const SEGREDO_FIX_P_FAMILIA: FamiliaComponente = {
    ...
    category: 'manufacturing',
    nodes: [
        { id: 'n-dna-segredo-p', type: 'dnaTableNode', data: { label: 'DNA Geométrico', cost: 0, type: 'dnaTable', dimensions: moedaFixPDims, mappingMode: 'diameter' }, position: { x: 100, y: 100 } },
        { id: 'n-mat-segredo-p', type: 'materialMapping', data: { label: 'Matéria-Prima', cost: 0, type: 'materialMapping', dimensions: moedaFixPDims, mappingMode: 'diameter' }, position: { x: 300, y: 100 } },
