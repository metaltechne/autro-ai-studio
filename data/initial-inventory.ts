...
export const FIX_S_FAMILIA: FamiliaComponente = {
    ...
    nodes: [
        ...
        { id: 'n-gen-s', type: 'productGeneratorNode', data: { label: 'Gerador FIX-S', cost: 0, type: 'productGenerator', generationConfig: { nameTemplate: 'Moeda FIX-S {bitola} {headCode}', skuTemplate: 'MOEDA-FIX-S-{bitola}-{headCode}' } }, position: { x: 900, y: 100 } },
    ],
    edges: [
...
export const FIX_P_FAMILIA: FamiliaComponente = {
    ...
    nodes: [
        ...
        { id: 'n-gen-p', type: 'productGeneratorNode', data: { label: 'Gerador FIX-P', cost: 0, type: 'productGenerator', generationConfig: { nameTemplate: 'Moeda FIX-P {bitola} {headCode}', skuTemplate: 'MOEDA-FIX-P-{fbitola}-{headCode}' } }, position: { x: 900, y: 100 } },
    ],
    edges: [
...
export const SEGREDO_FIX_P_FAMILIA: FamiliaComponente = {
    ...
    nodes: [
        ...
        { id: 'n-gen-segredo-p', type: 'productGeneratorNode', data: { label: 'Gerador Segredo', cost: 0, type: 'productGenerator', generationConfig: { nameTemplate: 'Segredo FIX-P (Ø{diametro}mm) {headCode}', skuTemplate: 'SEGREDO-FIX-P-D{fdiametro}-{headCode}' } }, position: { x: 900, y: 100 } },
    ],
    edges: [
...
export const SEGREDO_CHAVE_S_FAMILIA: FamiliaComponente = {
    ...
    nodes: [
        ...
        { id: 'n-gen-segredo', type: 'productGeneratorNode', data: { label: 'Gerador Segredo', cost: 0, type: 'productGenerator', generationConfig: { nameTemplate: 'Segredo Chave FIX-S {bitola} {headCode}', skuTemplate: 'SEGREDO-CHAVE-S-{headCode}' } }, position: { x: 900, y: 100 } },
    ],
    edges: [
