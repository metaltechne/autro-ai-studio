...
export const INITIAL_COMPONENTS: Component[] = [
    ...
    { id: 'comp-RM-BARRA-ROSCADA-M6', name: 'Barra Roscada M6', sku: 'RM-BARRA-ROSCADA-M6', type: 'raw_material', stock: 100, purchaseCost: 20.00, custoFabricacao: 0, custoMateriaPrima: 0, consumptionUnit: 'm', purchaseQuantity: 1 },
    { id: 'comp-RM-BARRA-ROSCADA-M8', name: 'Barra Roscada M8', sku: 'RM-BARRA-ROSCADA-M8', type: 'raw_material', stock: 100, purchaseCost: 30.00, custoFabricacao: 0, custoMateriaPrima: 0, consumptionUnit: 'm', purchaseQuantity: 1 },
    { id: 'comp-RM-BARRA-ROSCADA-M10', name: 'Barra Roscada M10', sku: 'RM-BARRA-ROSCADA-M10', type: 'raw_material', stock: 100, purchaseCost: 45.00, custoFabricacao: 0, custoMateriaPrima: 0, consumptionUnit: 'm', purchaseQuantity: 1 },
    { id: 'comp-RM-BARRA-ROSCADA-M12', name: 'Barra Roscada M12', sku: 'RM-BARRA-ROSCADA-M12', type: 'raw_material', stock: 100, purchaseCost: 60.00, custoFabricacao: 0, custoMateriaPrima: 0, consumptionUnit: 'm', purchaseQuantity: 1 },
    ...
    { id: 'comp-RM-BARRA-22-22', name: 'Barra de Aço 22.22mm (6m)', sku: 'RM-BARRA-22.22', type: 'raw_material', stock: 100, purchaseCost: 90.00, custoFabricacao: 0, custoMateriaPrima: 0, consumptionUnit: 'm', purchaseQuantity: 6 },
    { id: 'comp-RM-BARRA-INOX-3-8', name: 'Barra de Aço Inox 304 3/8" (6m)', sku: 'RM-BARRA-INOX-3-8', type: 'raw_material', stock: 100, purchaseCost: 150.00, custoFabricacao: 0, custoMateriaPrima: 0, consumptionUnit: 'm', purchaseQuantity: 6 },
    ...
    { id: 'comp-RM-TUBO-15-87', name: 'Tubo Inox Ø15.87mm (6m)', sku: 'RM-TUBO-15.87', type: 'raw_material', stock: 100, purchaseCost: 150.00, custoFabricacao: 0, custoMateriaPrima: 0, consumptionUnit: 'm', purchaseQuantity: 6 },
    ...
    { id: 'comp-COPO-19-05', name: 'Copo 19.05', sku: 'COPO-19.05', type: 'component', stock: 1000, purchaseCost: 0.20, custoFabricacao: 0, custoMateriaPrima: 0.20, sourcing: 'purchased', familiaId: 'fam-embalagens' },
    ...
    { id: 'comp-COPO-22-22', name: 'Copo 22.22', sku: 'COPO-22.22', type: 'component', stock: 1000, purchaseCost: 0.25, custoFabricacao: 0, custoMateriaPrima: 0.25, sourcing: 'purchased', familiaId: 'fam-embalagens' },
    ...
    { id: 'comp-COPO-25-40', name: 'Copo 25.40', sku: 'COPO-25.40', type: 'component', stock: 1000, purchaseCost: 0.35, custoFabricacao: 0, custoMateriaPrima: 0.35, sourcing: 'purchased', familiaId: 'fam-embalagens' },
    { id: 'comp-TAMPA-25-40', name: 'Tampa 25.40', sku: 'TAMPA-25.40', type: 'component', stock: 1000, purchaseCost: 0.15, custoFabricacao: 0, custoMateriaPrima: 0.15, sourcing: 'purchased', familiaId: 'fam-embalagens' },
    { id: 'comp-COPO-31-75', name: 'Copo 31.75', sku: 'COPO-31.75', type: 'component', stock: 1000, purchaseCost: 0.45, custoFabricacao: 0, custoMateriaPrima: 0.45, sourcing: 'purchased', familiaId: 'fam-embalagens' },
    ...
    { id: 'comp-COPO-STD', name: 'Copo Padrão', sku: 'COPO-STD', type: 'component', stock: 1000, purchaseCost: 0.30, custoFabricacao: 0, custoMateriaPrima: 0.30, sourcing: 'purchased', familiaId: 'fam-embalagens' },
...
export const FIX_S_FAMILIA: FamiliaComponente = {
    ...
    nodes: [
        ...
        { id: 'n-mat-s', type: 'materiaPrima', data: { label: 'Moeda (MP)', cost: 0, type: 'materiaPrima', baseMaterialId: 'comp-RM-MOEDA', consumption: 1 }, position: { x: 100, y: 250 } },
...
export const FIX_P_FAMILIA: FamiliaComponente = {
    ...
    nodes: [
        { id: 'n-dna-p', type: 'dnaTableNode', data: { label: 'DNA Geométrico', cost: 0, type: 'dnaTable', dimensions: [
            { id: 'dim-p-22', bitola: 22.22, comprimento: 0, code: 'B-0070' },
            { id: 'dim-p-19', bitola: 19.05, comprimento: 0, code: 'B-0074' },
            { id: 'dim-p-15', bitola: 15.8, comprimento: 0, code: 'B-0079' }
        ] }, position: { x: 100, y: 100 } },
        { id: 'n-mat-p', type: 'materiaPrima', data: { label: 'Moeda (MP)', cost: 0, type: 'materiaPrima', baseMaterialId: 'comp-RM-MOEDA', consumption: 1 }, position: { x: 100, y: 250 } },
...
export const CORPO_USINADO_FAMILIA: FamiliaComponente = {
    ...
    category: 'manufacturing',
    nodes: [
        { id: 'n-dna-cu', type: 'dnaTableNode', data: { label: 'DNA Geométrico', cost: 0, type: 'dnaTable', dimensions: corpoUsinadoDims }, position: { x: 100, y: 100 } },
        { id: 'n-mat-cu', type: 'materialMapping', data: { label: 'Mapeamento de Material', cost: 0, type: 'materialMapping', dimensions: corpoUsinadoDims }, position: { x: 300, y: 100 } },
        { id: 'n-cod-cu', type: 'codificationTable', data: { label: 'Tipo de Corpo', cost: 0, type: 'codificationTable', headCodes: [
            { id: 'hc-fix-p', code: 'FIX-P' },
            { id: 'hc-por-p', code: 'POR-P' }
        ] }, position: { x: 300, y: 250 } },
        { id: 'n-usinagem-cu', type: 'etapaFabricacao', data: { label: 'Usinagem CNC', cost: 0, type: 'etapaFabricacao', operationId: 'op-usin-cnc' }, position: { x: 500, y: 100 } },
...
export const MONTAGEM_POR_P_FAMILIA: FamiliaComponente = {
    ...
    nodes: [
        ...
        { id: 'n-inv-corpo-por', type: 'inventoryComponent', data: { label: 'Corpo Usinado POR-P', cost: 0, type: 'inventoryComponent', componentIdTemplate: 'CORPO-USIN-POR-P-M{bitola}', sourceFamiliaId: 'fam-CORPO-USINADO' }, position: { x: 100, y: 300 } },
...
export const SEGREDO_CHAVE_S_FAMILIA: FamiliaComponente = {
    ...
    nodes: [
        ...
        { id: 'n-mat-segredo', type: 'materiaPrima', data: { label: 'Moeda (MP)', cost: 0, type: 'materiaPrima', baseMaterialId: 'comp-RM-MOEDA', consumption: 1 }, position: { x: 100, y: 250 } },
...
export const MONTAGEM_CHAVE_S_FAMILIA: FamiliaComponente = {
    ...
    nodes: [
        ...
        { id: 'n-gen-mont-chave', type: 'productGeneratorNode', data: { label: 'Gerador Chave T', cost: 0, type: 'productGenerator', generationConfig: { nameTemplate: 'Chave T (FIX-S) {headCode}', skuTemplate: 'CHAVE-T-S-{headCode}' } }, position: { x: 700, y: 200 } },
    ],
    edges: [
...
export const MONTAGEM_CHAVE_PITO_S_FAMILIA: FamiliaComponente = {
    ...
    nodes: [
        ...
        { id: 'n-gen-mont-pito', type: 'productGeneratorNode', data: { label: 'Gerador Chave Pito', cost: 0, type: 'productGenerator', generationConfig: { nameTemplate: 'Chave Pito (FIX-S) {headCode}', skuTemplate: 'CHAVE-PITO-S-{headCode}' } }, position: { x: 700, y: 200 } },
    ],
    edges: [
...
const corpoChavePDims: ProcessDimension[] = [
    { id: 'dim-corpo-p-15-8', bitola: 15.8, comprimento: 35, baseMaterialId: 'comp-RM-TUBO-10', consumption: 0.035 },
...
export const SEGREDO_FIX_P_FAMILIA: FamiliaComponente = {
    ...
    nodes: [
        { id: 'n-dna-segredo-p', type: 'dnaTableNode', data: { label: 'DNA Geométrico', cost: 0, type: 'dnaTable', dimensions: [
            { id: 'dim-seg-p-15-8', bitola: 15.8, comprimento: 0 },
            { id: 'dim-seg-p-19-05', bitola: 19.05, comprimento: 0 },
            { id: 'dim-seg-p-22-22', bitola: 22.22, comprimento: 0 }
        ] }, position: { x: 100, y: 100 } },
        { id: 'n-mat-segredo-p', type: 'materiaPrima', data: { label: 'Moeda (MP)', cost: 0, type: 'materiaPrima', baseMaterialId: 'comp-RM-MOEDA', consumption: 1 }, position: { x: 100, y: 250 } },
...
const montagemChavePDims: ProcessDimension[] = [
    { id: 'dim-mont-p-15-8', bitola: 15.8, comprimento: 35, baseMaterialId: 'comp-RM-NUT-M6', consumption: 1 },
    { id: 'dim-mont-p-19-05', bitola: 19.05, comprimento: 35, baseMaterialId: 'comp-RM-NUT-M8', consumption: 1 },
    { id: 'dim-mont-p-22-22', bitola: 22.22, comprimento: 35, baseMaterialId: 'comp-RM-NUT-M10', consumption: 1 }
];
