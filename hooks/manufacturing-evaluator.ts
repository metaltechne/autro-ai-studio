...
export const evaluateProcess = (
    ...
    if (!generatorNode) return { custoMateriaPrima: 0, custoFabricacao: 0, totalTimeSeconds: 0, nodes: familia.nodes || [], costBreakdown: [], requirements: [] };
    ...
    return { custoMateriaPrima: totalMaterial, custoFabricacao: totalLabor, totalTimeSeconds, nodes: updatedNodes, costBreakdown: breakdown, requirements };
};
