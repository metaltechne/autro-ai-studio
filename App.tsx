...
const MainApplication: React.FC = () => {
    ...
    const viewMap: { [key in View]?: React.ReactNode } = {
        ...
        [View.PRODUCTION_FINANCIAL_FLOW]: <ProductionFinancialFlowView manufacturingOrdersHook={manufacturingOrdersHook} inventory={inventory} />,
        ...
        [View.SPREADSHEETS]: <SpreadsheetView inventory={inventory} manufacturing={manufacturing} setCurrentView={setCurrentView} />,
